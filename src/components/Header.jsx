...
const Header = ()=>{
    return(
        <header className={`${classes.header} flex justify-between bg-white items-center text-[1.4rem] h-[7rem] border border-color-grey-light-2 smallest:flex-wrap smallest:h-[11rem] smallest:content-around`}>
            {/* <div className={`pl-4`}> */}
                <img className={`h-[3.25rem] ml-8`} src={logo}></img>
            {/* </div> */}
            <form className={`flex items-center  justify-center relative  basis-[40%] smallest:order-1 smallest:basis-[100%]`}>
